...
styled(Icon$Q)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Jet home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Jet home page" }, innerLogo))));
};
...
var DustPrice = function (_a) {
    var dustPriceUsd = _a.dustPriceUsd;
    return dustPriceUsd ? (React.createElement(PriceLink, { href: "https://bscscan.com/address/0xb2a1be154c0416209805395e736aa638eaefd22e", target: "_blank" },
        React.createElement(Icon$N, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + dustPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var DustPrice$1 = React.memo(DustPrice);
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, dustPriceUsd = _a.dustPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            React.createElement(DustPrice$1, { dustPriceUsd: dustPriceUsd }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://help.moonwalker.network/faq", external: true },
...
var StyledButton$1 = styled(Button)(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  color: ", " \n"], ["\n  color: ", " \n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(StyledButton$1, { scale: "md", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(StyledButton$1, { scale: "md", onClick: function () {
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, dustPriceUsd = _a.dustPriceUsd, links = _a.links; _a.profile; var children = _a.children;
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, dustPriceUsd: dustPriceUsd, pushNav: setIsPushed, links: links }),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#FEC803", background: "#2B2B2B", backgroundDisabled: "#C7C7C7", contrast: "#FFFFFF", invertedContrast: "#343434", input: "#444444", inputSecondary: "#444444", primaryDark: "#FEC803", tertiary: "#444444", text: "#FFFFFF", textDisabled: "#777777", textSubtle: "#FFFFFF", borderColor: "#C7C7C7", card: "#343434", extra: "#FAC504", button: "linear-gradient(90deg, #FEC803 0%, #7C6A25 100%)", farming: 'rgba(255, 255, 255, 0.1)', gradients: {
