...
styled(Icon$n)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled(Icon$o)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b, img = _a.img;
    return (React.createElement(Container$3, null,
        React.createElement("img", { src: img, width: size + "px" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Polygon MoonWalkerSwap home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Polygon MoonWalkerSwap home page" }, innerLogo))));
};
...
var PDustPrice = function (_a) {
    ...
    return PDustPriceUsd ? (React.createElement(PriceLink, { href: "https://polygonscan.com/address/0x5ce9680bddc91d955a51b959f5cabaf466b0be5a", target: "_blank" },
        React.createElement(Icon$q, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + PDustPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var PDustPrice$1 = React.memo(PDustPrice);
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(PDustPrice$1, { PDustPriceUsd: PDustPriceUsd }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://polygon-docs.moonwalker.network/faq", external: true },
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(StyledButton, { scale: "md", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(StyledButton, { scale: "md", onClick: function () {
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, PDustPriceUsd: PDustPriceUsd, pushNav: setIsPushed, links: links }),
