...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://swap.moonwalker.network">Link</Link>);
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://swap.moonwalker.network">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz eiaRqE djpNeP"
